...
export default class StrategicCommunications extends Component {
    state = {
        posts: data.sort((a, b) => b.date - a.date).filter(a => a.category=== "Strategic Communication")
    }
    render() {
