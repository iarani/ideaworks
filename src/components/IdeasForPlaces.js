...
export default class IdeasForPlaces extends Component {
    state = {
        posts: data.sort((a, b) => b.date - a.date).filter(a => a.category=== "Ideas for Places")
    }
    render() {
